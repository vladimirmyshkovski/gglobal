...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['*'])#default=['xn--90a0am.xn------dddfnxoenlfghchl4bitc.xn--90ais', 'xn------dddfnxoenlfghchl4bitc.xn--90ais', '37.143.8.19', 'hosted-by.ihc.ru'])
