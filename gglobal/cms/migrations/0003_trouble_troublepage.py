# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-06-15 12:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trouble', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='service.Trouble')),
            ],
        ),
        migrations.CreateModel(
            name='TroublePage',
            fields=[
                ...
                ('trouble', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='cms.Trouble')),
            ],
            options={
                'abstract': False,
            },
