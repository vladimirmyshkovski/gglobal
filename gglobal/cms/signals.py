...
from gglobal.cms.models import ServicePage, TroublePage, ServicePageSnippet, Trouble as TroubleSnippet, CityPage
...
def create_service_page(sender, instance, created, **kwargs):
	...
	if created and instance.accepted:
		for city in citypages:
			service_snippet = ServicePageSnippet.objects.create(service=instance)
