# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-29 12:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='invoice',
            name='amount',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=None, default_currency='USD', max_digits=10, null=True, verbose_name='Сумма'),
        ),
        migrations.AlterField(
            model_name='invoice',
            name='issue_date',
            field=models.DateField(verbose_name='Когда долежн заплатить'),
        ),
        migrations.AlterField(
            model_name='invoice',
            name='paid',
